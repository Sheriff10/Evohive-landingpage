...
export default function Navbar() {
    ...
    const handleScroll = () => {
      const offsets = links
        .map((link) => {
          ...
          return el ? { href: link.href, offsetTop: el.getBoundingClientRect().top + window.scrollY } : null;
        })
  ...
  return (
    <nav className="relative z-50 max-w-[907px] w-[90vw] mx-auto mt-4 rounded-[20px] border border-white/15 bg-[#0A0A0A] backdrop-blur-sm px-4 md:px-6 text-white/70">
      {/* Main Navbar Content */}
